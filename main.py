...
GAMES = {
    "камень-ножницы-бумага": {
        ...
        "rules": {
            "камень": {"ножницы": "выигрыш", "бумага": "проигрыш", "камень": "ничья"},
            "ножницы": {"бумага": "выигрыш", "камень": "проигрыш", "ножницы": "ничья"},
            "бумага": {"камень": "выигрыш", "ножницы": "проигрыш", "бумага": "ничья"}
        }
    },
    "виселица": {
        "words": ["яблоко", "банан", "груша", "арбуз", "виноград", "клубника", "малина", "черешня"],
        "guesses": 10
    }
}
        ...
        while True:
            ...
            if user_move not in game["moves"]:
                ...
                if result == "выигрыш":
                    ...
                    print("Ничья. Попробуем ещё раз?")
                break
    elif game == GAMES["виселица"]:
        word = random.choice(game["words"])
        guesses = game["guesses"]
        guessed_letters = []
        print(f"Дан список фруктов 'яблоко, банан, груша, арбуз, виноград, клубника, малина, черешня'")
        print(f"Вам нужно отгадать по букве из какого-то загаданного слова {''.join(guessed_letters)}")
        print(f"Когда вы угадаете 1 из букв в слове, то попытка не будет высчитываться")
        while guesses > 0:
            ...
            if guess in word:
                ...
                if all(letter in guessed_letters for letter in word):
                    print(f"Поздравляю, вы выиграли, загаданное слово было:", word)
                    break
            else:
                guesses -= 1
        if guesses == 0:
